...
public static class Noise
{
    ...
    public static NoiseSample Sum(NoiseMethod method, Vector3 point, float frequency, int octaves, float lacunarity, float persistence)
    {
         ...
         * halving the amplitude, and keeping track of the total range for normalization. 
         * Because it is pointless to ask for zero octaves, let's always compute the first, then loop through the others.
         * 
    ...
    /*
     * The hash array will always produce a tiling pattern,
     * this is only noticeable when we see a too large sampling of it
     * At 256 elements, this is not an issue.
     */
    ...
    //Function used for making a smoothing curve
    ...
    public static NoiseSample Value1D(Vector3 point, float frequency)
    {
        ...
        float t = point.x - i0;
        i0 &= hashMask;
        int i1 = 10 + 1; //The coordinate after i0
    ...
    public static NoiseSample Value2D(Vector3 point, float frequency)
    {
        ...
        //Interpolants for bilinear interpolation
        ...
        return Mathf.Lerp(Mathf.Lerp(v00, v10, tx), Mathf.Lerp(v01, v11, tx), ty) * 2f;
    }
    ...
    public static float Value3D(Vector3 point, float frequency)
    {
        ...
        //Interpolants for trilinear interpolation
        ...
        int h110 = hash[h10 + iz0];
        int h001 = hash[h11 + iz1];
    ...
    public static float Perlin1D(Vector3 point, float frequency)
    {
        ...
        float g0 = gradients1D[hash[i0] & gradientsMask1D]; //Converts hash values into gradient functions
